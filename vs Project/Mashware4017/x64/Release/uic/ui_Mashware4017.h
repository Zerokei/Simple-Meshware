...
public:
    ...
    void setupUi(QMainWindow *Mashware4017Class)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("../images/OIP-C (1).jpg"), QSize(), QIcon::Normal, QIcon::Off);
        fill->setIcon(icon6);
        manual = new QAction(Mashware4017Class);
        manual->setObjectName(QString::fromUtf8("manual"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("../images/OIP-C.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        manual->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("../images/save-1779882-1518534.png"), QSize(), QIcon::Normal, QIcon::Off);
        save->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8("../images/R-C (3).png"), QSize(), QIcon::Normal, QIcon::Off);
        line->setIcon(icon9);
        ...
        openGLWidget->setGeometry(QRect(30, 50, 521, 271));
